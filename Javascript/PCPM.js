...
// @version      1.0
// @description  Page Monitor and Crudely scrape the page that can be displayed via Notifications
// @author       JRW254
...
//
const listItems = document.querySelectorAll(".list-item .study-info"); // This get's all the info but not in a great way.
//
let surNUM = document.querySelector(".list").getElementsByTagName("li").length; // Let us get the number of available survey's.
const notification = new Notification("Prolific Page Monitor\n Survey's Available: " + surNUM, { // Create and display the notifications.
