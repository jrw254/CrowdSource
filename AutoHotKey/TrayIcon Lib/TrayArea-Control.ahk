...
CLV.SelectionColors(0xff0000,0xffffff) ; when clicked changes Red with White Text    AlternateCols
       ...
       LV_Delete()
        ...
        FileAppend, TimeStamp for set: %timestamp%`n`r, C:\Code\AHK\TILIB.log
Loop, % test.MaxIndex() {
        ...
        FileAppend, %lDex%. %lName% Located within: %lLocation%`n`r, C:\Code\AHK\TILIB.log
}
 Run, C:\Code\AHK\TILIB.log
}
